...
| pipeline | Edge Gateway, AWS Lambda, DynamoDB, API Gateway | 작업 완료 | [pipeline.md](pipeline.md) |
...
| 페이즈 | 범위 | 상태 | 세부 문서 |
|---|---|---|---|
| firmware | ESP8266 펌웨어 (부트스트랩, mTLS rekey, EMQX publish) | 작업 완료 | [end.md](end.md) |